...
function travelHistoryPage() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (isUserTravelled) {
            travelHistoryPage.innerHTML = `<h1>Travel History</h1><button onclick=\"exportTableToCSV()\" id=\"exportButton\">Export</button><table border=\"2px\" cellpadding=\"8px\" id=\"travelHistory\"><tr><th>From Location</th><th>To Location</th><th>Date</th><th>Travel Cost</th><th>Booking Status</th></tr></table>`;
...
function exportTableToCSV() {
    var csv = [];
    var rows = document.querySelectorAll("#travelHistory tr");
    for (var i = 0; i < rows.length; i++) {
        var row = [];
        var columns = rows[i].querySelectorAll("#travelHistory td,th");
